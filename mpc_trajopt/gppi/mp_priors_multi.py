...
class Multi_MP_Prior:
    ...
    def __init__(
        ...
        # Assume goal factor is always provided, for now.
        self.goal_directed = True

        if means is None:
            self.num_modes = goal_states.shape[0]
            means = []
            for i in range(self.num_modes):
                means.append(self.get_const_vel_mean(
                    start_state,
                    goal_states[i],
                    dt,
                    num_steps,
